...
public class Guard extends Validator
{
	 ...
	 * @throws net.sf.oval.exception.InvalidConfigurationException if the declaring class is not guarded or the parameterIndex is out of range
	 */
	 ...
	 * @throws net.sf.oval.exception.InvalidConfigurationException if method does not declare a return type (void), or the declaring class is
	 *             not guarded
	 */
	@Override
	 ...
	 * @param checks
	 * @throws IllegalArgumentException if <code>method == null</code> or <code>checks == null</code> or checks is empty
	 * @throws net.sf.oval.exception.InvalidConfigurationException if the declaring class is not guarded
	 */
	 ...
	 * @throws net.sf.oval.exception.ValidationFailedException
	 */
	 ...
	 *
	 * @throws net.sf.oval.exception.ConstraintsViolatedException
	 * @throws net.sf.oval.exception.ValidationFailedException
	 */
	 ...
	 * This method is provided for use by guard aspects.
	 *
	 * @throws net.sf.oval.exception.ConstraintsViolatedException if anything precondition is not satisfied
	 * @throws net.sf.oval.exception.ValidationFailedException
	 */
	 ...
	 * @throws net.sf.oval.exception.ConstraintsViolatedException if an constraint violation occurs and the validated object is not in probe mode.
	 * @throws net.sf.oval.exception.ValidationFailedException
	 */
	...
	/**
	 * <b>Note:</b> Only required until AspectJ allows throwing of checked exceptions,
	 * then {@link #guardMethod(Object, java.lang.reflect.Method, Object[], net.sf.oval.internal.util.Invocable)} can be used instead
	 *
	 * This method is provided for use by guard aspects.
	 *
	 * @param returnValue
	 * @param preResult
	 * @throws net.sf.oval.exception.ConstraintsViolatedException if an constraint violation occurs and the validated object is not in probe
	 *             mode.
	 */
	...
	/**
	 * <b>Note:</b> Only required until AspectJ allows throwing of checked exceptions, then {@link #guardMethod(Object, java.lang.reflect.Method, Object[], net.sf.oval.internal.util.Invocable)} can be used instead
	 *
	 * This method is provided for use by guard aspects.
	 *
	 * @param guardedObject
	 * @param method
	 * @param args
	 * @return Null if method guarding is deactivated or a result object that needs to be passed to {@link #guardMethodPost(Object, net.sf.oval.guard.Guard.GuardMethodPreResult)}
	 * @throws net.sf.oval.exception.ConstraintsViolatedException if an constraint violation occurs and the validated object is not in probe
	 *             mode.
	 */
	 ...
	 * @throws IllegalArgumentException if <code>constructor == null</code> or <code>checks == null</code> or checks is
	 *             empty
	 * @throws net.sf.oval.exception.InvalidConfigurationException if the parameterIndex is out of range
	 */
