...
public interface ExpressionLanguage
{
	 ...
	 * @throws net.sf.oval.exception.ExpressionEvaluationException in case of an invalid expression
	 */
	 ...
	 * @param values context values passed to the interpreter
	 * @return the result of the expression evaluation 
	 * @throws net.sf.oval.exception.ExpressionEvaluationException If an error during evaluation occurs or if the return value is not a boolean value.
	 */
