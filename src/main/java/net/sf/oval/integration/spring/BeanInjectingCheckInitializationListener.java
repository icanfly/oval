...
/**
 * Injects Spring bean dependencies into {@link net.sf.oval.Check} instances.
 *
 * Required dependencies must be annotated with <code>@Autowired</code> within {@link net.sf.oval.Check} the class.
 *
