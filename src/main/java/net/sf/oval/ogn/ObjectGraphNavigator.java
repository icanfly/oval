...
public interface ObjectGraphNavigator
{
	 ...
	 * @throws net.sf.oval.exception.InvalidConfigurationException if the given path is invalid, e.g. because of non-existing fields/properties named in the path.
	 */
